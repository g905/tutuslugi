...
class SmsaeroApiV2
{
    ...
    private $email = 'md5020@yandex.ru'; //Ваш логин|email
    private $api_key = 'lJZpA40Tg32mBn82LEYLn2aN2q3jx5s2';  //Ваш api_key можно получить по адресу https://smsaero.ru/cabinet/settings/apikey/
    ...
    public function flash($number, $text, $dateSend = null, $callbackUrl = null){
