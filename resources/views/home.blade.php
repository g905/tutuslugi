                ...
                <ul>
                    @if(!empty($Categories))
                        @foreach($Categories as $Category)
                            <li>
                                <a href="@if(!empty($CityRegion)) /{{$CityRegion->url}}/@if(!empty($Category->parent_url)){{$Category->parent_url['slug']}}/@endif{{$Category->url}}/ @else /moskva/{{$Category->url}}/ @endif">
                                    <img src="/images/{{$Category->icon}}"/><span>{{$Category->name}}</span>
                                </a></li>
                        @endforeach
                    @endif
